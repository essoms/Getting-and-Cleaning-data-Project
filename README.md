...
This file contains R code which does the following:
1. It downloads the UCI HAR Dataset data set and puts into a working directrory. After it is downloaded, it unzips the file into the UCI HAR Dataset folder.
2. Loads the required packages and loads the train and test data sets and appends the two datasets into one data frame  using the rbind and cbind.
